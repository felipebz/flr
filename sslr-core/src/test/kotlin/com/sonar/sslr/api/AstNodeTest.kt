...
class AstNodeTest {
    ...
    fun test() {
        ...
        assertThat(a1.getFirstChild(mock())).isNull()
        ...
        assertThat(a1.getLastChild(mock())).isNull()
        ...
        assertThat(a1.getFirstDescendant(mock())).isNull()
        ...
        assertThat(a1.nextSibling).isNull()
        assertThat(c1.nextSibling).isNull()
        assertThat(b3.nextSibling).isSameAs(c2)
        assertThat(a1.previousSibling).isNull()
        assertThat(a2.previousSibling).isNull()
        assertThat(b2.previousSibling).isSameAs(a2)
        assertThat(a1.nextAstNode).isNull()
        assertThat(b1.nextAstNode).isSameAs(b2)
        assertThat(a1.previousAstNode).isNull()
        assertThat(b2.previousAstNode).isSameAs(a2)
