...
enum class RegularExpressionGrammar : GrammarRuleKey {
    ...
    companion object {
        ...
        fun create(): Grammar {
            ...
            b.rule(TERM).`is`(
                b.firstOf(ATOM, POSITIVE_LOOKAHEAD, NEGATIVE_LOOKAHEAD, NON_CAPTURING_GROUP, CAPTURING_GROUP),
